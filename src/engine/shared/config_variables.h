...
#include "././game/server/city/config.h"
...
MACRO_CONFIG_INT(SvPort, sv_port, 8303, 0, 65535, CFGFLAG_SERVER, "Port to use for the server")
MACRO_CONFIG_INT(SvExternalPort, sv_external_port, 0, 0, 0, CFGFLAG_SERVER, "External port to report to the master servers")
MACRO_CONFIG_STR(SvMap, sv_map, 128, "dm1", CFGFLAG_SERVER, "Map to use on the server")
MACRO_CONFIG_INT(SvMaxClients, sv_max_clients, 64, 1, MAX_PLAYERS, CFGFLAG_SERVER, "Maximum number of clients that are allowed on a server")
...
MACRO_CONFIG_STR(SvRconPolicePassword, sv_rcon_police_password, 32, "", CFGFLAG_SERVER, "Remote console password for police (limited access)")
