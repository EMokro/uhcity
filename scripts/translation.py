...
def ConvertPo2Json(languageCode, plurals):
	if os.path.isfile("../uhcity-translation/uhcitypot_"+languageCode+".po"):
		poFileName = "../uhcity-translation/uhcitypot_"+languageCode+".po"
		jsonFileName = "./server_lang/"+languageCode+".json"
